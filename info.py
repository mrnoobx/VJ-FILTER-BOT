...
URL = "https://kannadaflixbot-dejg.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://kannadaflixbot-dejg.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://kannadaflixbot-dejg.onrender.com/".format(FQDN)
else:
    URL = "https://kannadaflixbot-dejg.onrender.com/".format(FQDN)
